...
export const Footer = () => {
    ...
    const socialLinks = [
        { icon: <Linkedin size={18} />, href: "https://www.linkedin.com/in/md-rakib-ali-383947218/", label: "LinkedIn" },
        { icon: <Instagram size={18} />, href: "https://www.instagram.com/rakibislam789/", label: "Instagram" },
        { icon: <Facebook size={18} />, href: "https://www.facebook.com/rakibislam.KCN", label: "Facebook" },
        { icon: <Github size={18} />, href: "https://github.com/Rakibislam22", label: "GitHub" },
    ];
    ...
    const contactInfo = [
        { icon: <Mail size={16} />, text: "mdrakibali.kcn@gmail.com", href: "mailto:mdrakibali.kcn@gmail.com" },
        { icon: <Phone size={16} />, text: "+880 1786935744", href: "tel:+8801786935744" },
    ];
                ...
                >
                    <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
                        ...
                        <motion.div variants={itemVariants} className="space-y-4">
                            <h3 className="text-xl font-bold text-gray-900 dark:text-white">RAKIB</h3>
                    ...
                    >
                        <div>
                            <p>© {currentYear} Rakib. All rights reserved.</p>
                        </div>
